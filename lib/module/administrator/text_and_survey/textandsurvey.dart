...
class TextAndSurvey extends StatefulWidget{
  final String initatorid;
  TextAndSurvey({Key key,this.initatorid}):super(key :key);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _TextAndSurveyState(initatorid);
  }

}

class _TextAndSurveyState extends State<TextAndSurvey> {
  var _publicTitle ='';//标题
  var _publicDescription = '';//具体描述
  GlobalKey _formKey= new GlobalKey<FormState>();
  String _initatorid = '';
  _TextAndSurveyState(String initatorid){
...
//
                            ...
                            survey.save().then((BmobSaved bmobsaved){
                              ...
                              Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context){
                                return new DesignProblemPage(survey_content: null,objectid: bmobsaved.objectId,);
